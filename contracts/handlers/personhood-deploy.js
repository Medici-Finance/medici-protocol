...
const Contract = JSON.parse(fs.readFileSync('./out/Personhood.sol/Personhood.json'));
...
async function main() {
  ...
  let tx = await wallet.sendTransaction({
    data: hexlify(concat([Contract.bytecode.object, abi.encode(Contract.abi[0].inputs, [worldIDAddress, ...inputs])])),
